...
class Kohana_Exception extends Exception {
	...
	public function __construct($message, array $variables = NULL, $code = 0)
	{
		...
		// Set the message
		$message = str_replace(array_keys($variables), $variables, $message); //__($message, $variables);
	...
	public static function text(Exception $e)
	{
		return sprintf('%s [ %s ]: %s ~ %s [ %d ]',
			get_class($e), $e->getCode(), strip_tags($e->getMessage()), /*Debug::path($e->getFile())*/$e->getFile(), $e->getLine());
	}
